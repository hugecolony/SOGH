...
<div id="ab-full-width-with-dismiss-button-on-blue-bg" class="hs-removing:-translate-y-full bg-blue-600 hidden-mobile">
  ...
  <div id="secondary-nav-toggle" class=" hs-collapse hidden overflow-hidden transition-all duration-300 absolute top-16 end-0 w-full rounded-lg bg-blue-600 sm:block sm:static sm:top-0 sm:w-full sm:max-h-full sm:bg-transparent sm:overflow-visible">
    ...
    <div class="flex flex-col py-2 sm:flex-row sm:justify-end sm:gap-y-0 sm:gap-x-6 sm:py-0">
      ...
      <a class="text-sm font-medium text-blue-500 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5 dark:text-neutral-300 dark:hover:text-white" href="/pages/carrers">CARRERS</a>
      <span class="inline-block border-e border-white/30 w-px h-auto mx-2"></span>
      ...
      <a class="text-sm font-medium text-blue-500 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5 dark:text-neutral-300 dark:hover:text-white" href="/search">FIND A DOCTOR</a>
        </div>
  </div>
</nav>
<!-- End Nav -->
...
{{--     
                      ...
                      <li>
                        ...
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav__link  hover:from-blue-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-blue-600" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                        @endif

                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav__link  hover:from-blue-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-blue-600" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav__link  hover:from-blue-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-blue-600" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }}
                            </a>
